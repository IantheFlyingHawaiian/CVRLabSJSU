    ...
    public class SplineEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            if (!Event.current.control)
            {
                ...
                if (EditorX.Circlelever(transform.position, Color.red, btnSize))
                {
                    selectedControl = -1;
                    Tools.hidden = false;
                }
            ...
            {               
                ...
                else
                {
                    ...
                    if (EditorX.Circlelever(cpPos, isPivot ? Color.blue : Color.cyan, isPivot ? btnSize : btnSize * 0.75f))
                    {
                        selectedControl = i;
                        Tools.hidden = true;
            ...
            for (int i = 0; i < spline.ControlCount; i++)
            {
                ...
                if (EditorX.Circlelever(center, Color.green, handleSz * 0.7f))
                {
